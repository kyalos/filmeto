...
if(!isset($_SESSION["loggedin"])){
    ...
    $_SESSION['current_url'] = "http://localhost/filmeto/home_logged.php";
...
$successmsg1 = "";
    ...
    $sql= mysqli_query($conn,"select id,random_id, load_name, SUBSTRING_INDEX(name, ' ', 3) as nn from video") or die(mysqli_error($conn));
            $tabs = array();
...
<!-- something should be here -->
  ...
  <main class="grid" style="margin-top: 0px;">
  ...
  let url = "/filmeto/get_comments.php";
    fetch(url,options)
      ...
      btn<?php echo $tb['random_id'];?>.onclick = function() {
       ...
       var gtid = <?php echo $tb['random_id'];?>;
      }
