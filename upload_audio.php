...
if(!isset($_SESSION["loggedin"])){
    ...
    $_SESSION['current_url'] = "http://localhost/filmeto/upload_audio.php";
...
if($imageFileType != "mp4" && $imageFileType != "mv4a" && $imageFileType != "mp3" && $imageFileType != "ogg" && $imageFileType != "wav")
{
...
$sql = "insert into audio(name) values('$video_path')";
